...
const CreateService = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const createservice = yield prismaClient_1.default.service.create({
        data: payload
    });
...
const GetallService = () => __awaiter(void 0, void 0, void 0, function* () {
    const allservice = yield prismaClient_1.default.service.findMany();
    return allservice;
});
// ------getsingle service-------
const GetsingleService = (serviceId) => __awaiter(void 0, void 0, void 0, function* () {
    const singleservice = yield prismaClient_1.default.service.findUnique({
        where: { serviceId }
    });
...
const UpdateComplete = (serviceId, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const updateservice = yield prismaClient_1.default.service.update({
        where: { serviceId },
        data: payload
    });
...
const OverdueServices = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const dueservice = yield prismaClient_1.default.service.findMany({
        where: {
            status: {
